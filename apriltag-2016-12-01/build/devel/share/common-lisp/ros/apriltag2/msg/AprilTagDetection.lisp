...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name apriltag2-msg:<AprilTagDetection> is deprecated: use apriltag2-msg:AprilTagDetection instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltag2-msg:id-val is deprecated.  Use apriltag2-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltag2-msg:size-val is deprecated.  Use apriltag2-msg:size instead.")
  (size m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltag2-msg:pose-val is deprecated.  Use apriltag2-msg:pose instead.")
  (pose m))
