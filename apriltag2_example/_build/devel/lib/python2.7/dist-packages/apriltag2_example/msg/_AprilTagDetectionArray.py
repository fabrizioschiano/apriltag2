...
"""autogenerated by genpy from apriltag2_example/AprilTagDetectionArray.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['apriltag2_example/AprilTagDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = apriltag2_example.msg.AprilTagDetection()
        _x = val1
        start = end
        end += 12
