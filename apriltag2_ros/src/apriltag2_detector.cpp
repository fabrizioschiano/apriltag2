...
#include <apriltag2_ros/AprilTagDetection.h>
#include <apriltag2_ros/AprilTagDetectionArray.h>
#include "tag16h5.h"
#include "tag25h7.h"
...
std::map<int, AprilTagDescription> AprilTagDetector::parse_tag_descriptions(XmlRpc::XmlRpcValue& tag_descriptions){
  ...
  for (int32_t i = 0; i < tag_descriptions.size(); ++i) {
    ...
    ROS_INFO_STREAM("[APRILTAG2]--Loaded tag config: "<<id<<", size: "<<size<<", frame_name: "<<frame_name);
